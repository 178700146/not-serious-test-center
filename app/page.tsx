    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f7f2e7] text-[#1d2431]">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 pb-10 pt-5 sm:px-8 sm:pt-7 lg:px-12">
        <header className="flex items-center justify-between gap-4">
          ...
          <span className="rounded-full border border-[#2e3552]/15 bg-[#fffaf0]/80 px-3.5 py-2 text-xs font-bold text-[#535b6c] shadow-sm">已收录 05 项</span>
        </header>
        ...
        <footer className="flex flex-col gap-2 py-9 text-xs font-semibold text-[#888a8f] sm:flex-row sm:items-center sm:justify-between"><p>不太正经测试中心 · 为好奇心保留一张座位</p><p>第 05 期 · 宝可梦剪影局已上线</p></footer>
      </div>
    </main>
  );
}
