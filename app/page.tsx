...
const tests: TestCard[] = [
  {
    ...
    state: 'available',
    href: '/mushroom',
    image: '/covers/quizzes/mushroom.png',
    imageAlt: '蘑菇大师测试封面',
    icon: Leaf,
    color: 'mushroom-card',
  },
  ...
  },
  {
    ...
    state: 'available',
    href: '/bird-calls',
    image: '/covers/bird-call-final.png',
    imageAlt: '鸟鸣识别测试封面',
    icon: Headphones,
    color: 'bird-card',
  },
  {
    ...
    state: 'available',
    href: '/ultraman-face',
    image: '/covers/quizzes/ultraman-face.png',
    imageAlt: '奥特曼认脸局测试封面',
    icon: Sparkles,
    color: 'tree-card',
  },
  {
    ...
    state: 'available',
    href: '/ultraman-sound',
    image: '/covers/quizzes/ultraman-sound.png',
    imageAlt: '奥特曼听声局测试封面',
    icon: Sparkles,
    color: 'scent-card',
  },
  {
    ...
    state: 'available',
    href: '/pokemon',
    image: '/covers/quizzes/pokemon.png',
    imageAlt: '宝可梦剪影局测试封面',
    icon: Sparkles,
    color: 'scent-card',
  },
  {
    ...
    state: 'available',
    href: '/dialect',
    image: '/covers/quizzes/dialect.png',
    imageAlt: '方言捕手测试封面',
  ...
  },
  {
    ...
    image: '/covers/foreign-country-final.png',
    imageAlt: '外语猜国家测试封面',
    icon: Globe2,
    color: 'scent-card',
  },
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 pb-10 pt-5 sm:px-8 sm:pt-7 lg:px-12">
        ...
        <section id="top" className="grid items-end gap-9 pb-10 pt-16 lg:grid-cols-[1.08fr_.92fr] lg:pb-16 lg:pt-24">
          <div>
            ...
            <div className="mt-9 flex flex-wrap gap-3"><a href="#tests"><Button size="lg" className="h-12 rounded-2xl bg-[#252b49] px-5 font-bold text-[#fff9ea] shadow-[4px_4px_0_#f0ad50] hover:bg-[#373f64]">开始乱逛 <ChevronRight className="size-4" /></Button></a><a href="/mushroom"><Button variant="outline" size="lg" className="h-12 rounded-2xl border-[#cdd1d5] bg-[#fffdf8]/75 px-5 font-bold text-[#3f4657] hover:bg-white">先测蘑菇 <ArrowUpRight className="size-4" /></Button></a></div>
          </div>
        ...
        <footer className="flex flex-col gap-2 py-9 text-xs font-semibold text-[#888a8f] sm:flex-row sm:items-center sm:justify-between"><p>不太正经测试中心 · 为好奇心保留一张座位</p><p className="flex items-center gap-3"><span>第 09 期 · 三项新测试已上线</span><a href="/credits" className="hover:underline">素材署名</a><a href="/admin" className="text-[#d85f48] hover:underline">站长入口</a></p></footer>
      </div>
    </main>
  );
}
