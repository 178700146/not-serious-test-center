...
export const defaultEditableTests: EditableTest[] = [
  ...
  { id: 'bird-calls', eyebrow: 'NO. 003 · 50 题库｜10 / 20 题可选', title: '鸟鸣识别', description: '树叶还没动，你先听出是哪只鸟。', image: '/covers/bird-call.svg' },
  ...
  { id: 'foreign-country', eyebrow: 'NO. 008 · 50 题库｜10 / 20 题可选', title: '外语猜国家', description: '听一小句陌生话，猜它从哪个国家来。', image: '/covers/foreign-country.svg' },
  { id: 'insects', eyebrow: 'NO. 009 · 50 题库｜10 / 20 题可选', title: '昆虫侦探', description: '看一眼触角、翅脉和腿，猜出它是谁。', image: '/covers/insect.svg' },
];
