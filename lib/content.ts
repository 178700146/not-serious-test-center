...
export const defaultEditableTests: EditableTest[] = [
  ...
  { id: 'ultraman-face', eyebrow: 'NO. 003 · 50 题库｜10 / 20 题可选', title: '奥特曼认脸局', description: '看形象，叫出这位光之巨人的名字。', image: 'https://ultraman-face-quiz.kind-song-3636.chatgpt.site/og.png' },
...
export function sanitizeEditableTests(value: unknown): EditableTest[] {
  ...
  return defaultEditableTests.map((fallback) => {
    ...
    return {
      ...
      image: clean(incoming.image, fallback.image, 500),
    };
  });
}
